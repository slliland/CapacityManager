...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.12.1",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-v_zt9njv\overlay\Lib\site-packages\pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-dskf9r9k\cp310-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.10",
        },
    }
)
